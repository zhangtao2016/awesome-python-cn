...
*   AkShare：一个开源金融数据接口库。[官网](https://github.com/jindaxiang/akshare)
*   BaoStock：一个免费、开源的python证券数据接口包。[官网](https://pypi.org/project/baostock/)
*   DTShare：一个完全开源免费的数据开放项目。[官网](https://github.com/DTShare/dtshare)
